...
- Per-IP rate limiting on `/api/chat` (20 requests/minute).
...
- [ ] Rate limiting: send >20 chat requests in under a minute from one IP and confirm the 429-style limiter message appears instead of a crash.
